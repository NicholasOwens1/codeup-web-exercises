...
// let percentMessage = prompt("What percentage would you like to tip?");
// let billAmount = prompt("How much is the bill?");
// let tipPercent = parseFloat(percentMessage);
// let bill = parseFloat(billAmount);
//
// alert(`The tip amount is $${calculateTip(tipPercent, bill)}.`);
//
// /**
//  * TODO:
